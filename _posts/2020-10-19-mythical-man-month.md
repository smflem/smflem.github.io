...
- Management
excerpt: |
  Why adding people to a complex project can lead to slower and worse outcomes, and what that might mean for perennial challenges in managing knowledge work.
---

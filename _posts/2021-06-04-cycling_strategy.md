...
To oversimplify, a rider might know that, in the abstract, they have a certain reserve of energy and can output so many watts for so many hours before exhaustion[^fueling]. They might further know that they can realize a much higher peak output, but only for a dozen seconds (in the case of a sprint) or a few minutes (in case of an maximum climbing effort) and at the cost of disproportionate drain on their reserves (and damage to their bodies).

The trick is--unlike an engineered system--these variables, for a given rider on a given day, are strictly unknowable. Past experience (by the rider, and as observed by their and opposing teams) will be some guide, but not nearly enough to avoid upsets and surprises.

If a rider sprints off the front of the group (expending a huge amount of energy), will they have enough left to carry them to the finish in the lead? How will the motivation of [eleven][nizzolo_background] 2nd-place finishes impact someone's sprint effort? When the final hill arrives, after 170km of riding[^preamble], which of the leaders are fresh enough to attack (or even keep the pace)? Will heroic efforts in stage [9][bernal_gravel_finish], [14][bernal_zoncolan] and [16][bernal_giau] leave a leader assailable by stage [17][bernal_struggling]?
...
In an ideal world, a successful sprint involves a team forming a leadout train and 'dropping off' their sprinter with ~150-200m left for their final huge effort[^sprint_gremlin]. This [stage finish][paris-nice_dck_leadout] from this year's Paris-Nice is one example of what this _should_ look like.
...
How do you get away from people who can just draft behind you to keep up? With a huge surge in effort, often coupled with the element of surprise.

How do you stay away from a huge blob of riders that can spread the work across themselves? By forming a small group that can coordinate better than the blob, and hoping for some luck and divergent goals among the GC teams[^controlling_the_race].

In the early portions of a stage, riders will often set off from the front of the group in the hopes of forming a breakaway[^normal_breakaway]. They want other riders, but not the peloton, to follow their move[^get_across] and provide enough hopefuls for the group to share the workload and keep away from the blob.
...
Sprints are decided by timing, positioning, and maximum output levels; the breakaway's success depends on judicious expenditure of energy. Don't spend enough, and the breakaway is caught. Overspend as a group and hit a limit, and the breakaway is caught. Overspend as an individual, and the breakaway might stay away but you'll lose to a rival at the final hill or sprint.
